            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <?php
                        ...
                        $sql1 = "SELECT * FROM `bills` WHERE `paid` = 0 AND `user_id_bill` = $id";
                        
                        $numberOfPendingBills = mysqli_query($conn, $sql1);
                        echo "<small>Total of pending bills: ".mysqli_num_rows($numberOfPendingBills)."</small>";
                        //echo mysqli_num_rows($result1);
                    
                        if (mysqli_num_rows($numberOfPendingBills) > 0) {
                            
                            //Show all pending bills
                            $sql = "SELECT * FROM bills WHERE `paid` = 0 AND user_id_bill='$id'";
                            $result = mysqli_query($conn, $sql);
                                 ...
                                 echo "
                                    ...
                                    <div class='card'>
                                      ...
                                      <div class='card-body'>
                                        ...
                                        <form action='#' method='POST' role='form'>
                                        <a href='pay-bill.php?billid=$billId'><button type='button' name='paid' class='btn btn-success'>Mark as paid</button></a>
                                        <a href='edit-bill.php?billid=$billId'><button type='button' name='edit' class='btn btn-primary'>Edit</button></a>
                                        <small class='float-right'>Date registered: $regD</small>
                                        </form>
                                      </div>
                                    </div><br>                            
